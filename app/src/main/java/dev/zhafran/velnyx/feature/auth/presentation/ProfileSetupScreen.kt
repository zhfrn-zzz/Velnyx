...
fun ProfileSetupScreen(
    ...
    Surface(
        ...
        Column(
            ...
            Text("ProfileSetupScreen", style = MaterialTheme.typography.headlineLarge)
            Text("(placeholder)", style = MaterialTheme.typography.bodyMedium)
            Spacer(modifier = Modifier.height(VelnyxSpacing.xl))
            VelnyxPrimaryButton(text = "Continue", onClick = onNavigateToPermissions)
        }
    }
}
...
fun ProfileSetupScreenPreview() {
    VelnyxTheme { ProfileSetupScreen() }
}
